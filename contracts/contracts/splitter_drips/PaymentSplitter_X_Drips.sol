...
contract PaymentSplitter_X_Drips is Context, Initializable {
  ...
  IAddressDriver public _IAddressDriver;
   ...
   */
  constructor(IAddressDriver IAddressDriver_) payable {
    _IAddressDriver = IAddressDriver_;
  }
  ...
  function collectDrips(IERC20 erc20) public returns (uint128 amt) {
    amt = _IAddressDriver.collect(erc20, address(this));
    distribute(erc20);
  }
